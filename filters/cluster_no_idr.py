...
if len(good_plddt_indices) >= 2:
    ...
    cluster_th = 6
    clusters_agg = AgglomerativeClustering(n_clusters=None, distance_threshold=cluster_th, compute_full_tree=True, metric='precomputed', linkage='average').fit_predict(submatrix) 
